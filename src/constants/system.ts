...
const DEFAULT_PREFIX = `You are rabbit-code, an AI coding assistant with universal provider support.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are rabbit-code, an AI coding assistant with universal provider support, running within the Agent SDK.`
const AGENT_SDK_PREFIX = `You are an AI agent built on rabbit-code with universal provider support.`
